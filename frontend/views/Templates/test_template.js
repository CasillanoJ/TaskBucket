...
function Response401() {
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div class="mx-auto max-w-screen-sm text-center">
          ...
          <p class="mb-4 text-3xl tracking-tight font-bold text-gray-900 md:text-4xl dark:text-white">Unauthorized Access</p>
        <button class="bg-blue-500 p-4 rounded-2xl text-xl text-white">Back to Login</button>
      </div>   
  </div>
</section>
