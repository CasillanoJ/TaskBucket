...
async function ConfirmSaveBtn(button) {
  ...
  const data = await UpdateSpecificTask(
    dataId,
    taskTitle.value,
  ...
  <span>Warning: Error Updating the Task!</span>
    ...
    //   FetchTaskList("", value, null);
    // } else {
    //   FetchTaskList("", value, null);
    //   FetchTaskList("", value, null);
    // }
    // await FetchTaskList("", "viewTaskList");
