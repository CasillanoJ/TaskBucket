const CreateDeleteModal = async()=>{
  ...
  <div class="modal-box bg-white dark:bg-secondary relative">
    ...
    <p class="py-4 text-center text-black dark:text-txt-100">You’re about to <span class="text-red-700">DELETE</span> this task</p>

    <div class="flex justify-center space-x-12 mt-5">
      <button class="text-white dark:text-black rounded-full bg-light-primary px-5 py-2 dark:bg-primary-100 dark:hover:bg-primary-200 hover:bg-light-primary-active" id="confirm-delete-modal-bttn" onclick="ConfirmDeleteModal(this)">Confirm</button>
      <form method="dialog">
...
<dialog id="succesfully_delete_modal" class="modal">
  <div class="modal-box bg-white dark:bg-secondary">
    <h3 class="font-bold text-lg text-center text-black dark:text-txt-100">Succesfully Deleted the task</h3>
