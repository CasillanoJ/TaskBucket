const CreateEditModal = (task) => {
    ...
    <div class="relative bg-white dark:bg-task-bg rounded-lg shadow dark:bg-dashboardBG modal-box  overflow-hidden w-11/12 max-w-2xl ">
        ...
        <div class=" p-5 border-t dark:border-gray-600 mt-16  ">
              ...
              <button type="button" id="edit-modal-${task._id}"   class=" text-white dark:text-black border-0 inline-flex items-center bg-primary-700 hover:bg-primary-800  focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-xl px-5 py-2 text-center dark:bg-primary-600 dark:hover:bg-primary-200 bg-light-primary  dark:bg-primary-100 dark:hover:text-black dark:focus:ring-primary-800">
          ...
          <form method="dialog">
            <button  id="edit-modal-${task._id}"   class="border-0 text-black dark:text-white  inline-flex items-center bg-primary-700 hover:bg-primary-800  focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-xl px-5 py-2 text-center dark:bg-primary-600 dark:hover:bg-primary-100  hover:bg-light-primary  bg-transparent  dark:hover:text-black dark:focus:ring-primary-800">
