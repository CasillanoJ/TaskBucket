const CreateCard = (task)=> {
    ...
    <div class="w-100 p-4 group" id="${task._id}" data-id="${task._id}" onclick="Task_modal_${task._id}.showModal()" >
          <div
                class="flex items-start bg-light-overiew-bg dark:bg-task-content rounded-xl shadow-lg h-40  hover:border-light-primary hover:border-2 dark:hover:border-primary">
                ...
                <div class="ml-5 mt-3 flex-grow">
                  ...
                  <p class="text-gray-400 dark:text-second-text-color mt-1 md:text-sm">Due Date: ${datePart}</p>
                </div>
