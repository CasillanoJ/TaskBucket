    ...
    <dialog id="confirm_accept_modal" class="modal">
      <div class="modal-box bg-white dark:bg-secondary relative">
        ...
        <div class="flex justify-center space-x-10 mt-5">
          <button class="text-white dark:text-black rounded-full bg-light-primary px-5 py-2 dark:bg-primary-100 dark:hover:bg-primary-200 hover:bg-light-primary-active" id="confirm-accept-modal-btn" onclick="ConfirmAcceptModal(this)">Confirm</button>
          <form method="dialog">
