export const CreateRejectModal = () => {
  const modalHTML = `
    <dialog id="confirm_reject_modal" class="modal">
      <div class="modal-box bg-white dark:bg-secondary relative">
        ...
        <p class="py-4 text-center text-black dark:text-txt-100">You’re about to <span class="text-red-700">REJECT</span> this member</p>
        <div class="flex justify-center space-x-10 mt-5">
          <button class="text-white dark:text-black rounded-full bg-light-primary px-5 py-2 dark:bg-primary-100 dark:hover:bg-primary-200 hover:bg-light-primary-active" id="confirm-reject-modal-btn" onclick="ConfirmRejectModal(this)">Confirm</button>
          <form method="dialog">
    ...
    <dialog id="successfully_reject_modal" class="modal">
